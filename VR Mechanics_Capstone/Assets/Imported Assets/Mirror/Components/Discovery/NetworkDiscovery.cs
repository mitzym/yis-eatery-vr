...
namespace Mirror.Discovery
{
    ...
    public class NetworkDiscovery : NetworkDiscoveryBase<ServerRequest, ServerResponse>
    {
        ...
        protected override ServerRequest GetRequest() => new ServerRequest(); //message that will be broadcasted to return servers
        ...
        protected override void ProcessResponse(ServerResponse response, IPEndPoint endpoint) //process response of server, passes in response & address of server that replied
        {
